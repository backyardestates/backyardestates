...
export default async function ProposalsPage({
    ...
    try {
        ...
        if (msg === "UNAUTHORIZED") redirect("/sign-in?redirect_url=/tools/proposals");
        throw err;
    }
                ...
                <div className={s.empty}>
                    {total === 0 ? (
                        ...
                        <p>
                            ...
                            <Link href="/tools/proposals">Show all</Link>
                        </p>
                    )}
                </div>
            ) : (
                                    ...
                                    <tr key={p.id}>
                                        ...
                                        <td>
                                            <ProposalRowMenu
                                                ...
                                                canBuild={canBuild}
                                                sharedWithCustomer={!!p.sharedWithCustomerAt}
                                            />
                                        </td>
                                    </tr>
                                );
...
function FilterTab({ label, value, active }: { label: string; value: ProposalStatus | null; active: boolean }) {
    return (
        <Link
            href={value === null ? "/tools/proposals" : `/tools/proposals?status=${value}`}
