...
// The Claude analysis can run well past the default serverless limit. Without
// a raised budget the function is killed mid-request and returns a non-JSON
// error page, which surfaces on the client as an opaque JSON parse error.
