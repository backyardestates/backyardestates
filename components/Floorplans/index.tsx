...
const FLOORPLANS_QUERY = `*[_type == "floorplan" && isClickable != false]|order(orderID asc){orderID, isClickable, wistiaID,slug, name, bed, bath, sqft, length, width, price, videoID, drawing, download, images}`
